...
const channelPerformance = [
  { channel: "WhatsApp", leads: 156, conversions: 89, revenue: 16630, conversionRate: 57.1 },
  { channel: "Landing Pages", leads: 234, conversions: 76, revenue: 14212, conversionRate: 32.5 },
...
const salesFunnel = [
  { stage: "Visitantes", count: 12540, percentage: 100, color: "bg-blue-500" },
  { stage: "Leads", count: 702, percentage: 5.6, color: "bg-green-500" },
                  ...
                  <div className="relative">
                    <div className="w-full bg-accent/20 rounded-full h-3">
                      <div 
                        ...
                        style={{ width: `${stage.percentage * 15}%` }}
                      ></div>
                    </div>
                  </div>
